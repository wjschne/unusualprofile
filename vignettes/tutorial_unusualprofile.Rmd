...
The unusualprofile package automates the process of making sense of multidimensional test battery results using latent-variable-based methods [@ji2018].
...
Suppose there are *k* outcome scores, and *j* composite scores used to calculate the expected scores $\hat{X}$. If multivariate normality of the subtest scores can by assumed, then the Conditional Mahalanobis Distance squared has a *χ*^2^ distribution with *k* − *j* degrees of freedom.
